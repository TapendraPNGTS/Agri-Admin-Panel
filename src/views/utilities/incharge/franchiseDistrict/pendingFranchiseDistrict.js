...
import FranchiseStateApi from "../../../../api/franchiseDistrict.api";
...
export default function DataTable() {
  ...
  const rows = useSelector((state) => state.franchiseDistrict.FranchiseDistrict);

  const getAllState = useCallback(async () => {
    try {
      const state = await stateApi.getAllPendingDistrictFranchise({});
