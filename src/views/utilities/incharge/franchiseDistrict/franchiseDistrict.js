...
export default function DataTable() {
  ...
  const stateApi = new FranchiseDistrictApi();
  ...
  const getAllDistrict = useCallback(async () => {
    try {
      const state = await stateApi.getAllDistrictFranchise({});
    ...
    <>
      ...
      <MainCard
        title={
          ...
          >
            <Grid item>
              <Typography variant="h3">District Incharge</Typography>
            </Grid>
            <Grid item>
              <Button
                variant="outlined"
                onClick={(e) => {
                  navigate("/add-franchise-district");
                }}
                startIcon={<AddIcon />}
              >
                Add District Incharge
              </Button>
            </Grid>
          </Grid>
        }
                            ...
                            {/* <TableCell align="center" sx={{ pr: 3 }}>
                              ...
                              >
                                <Tooltip
                                  ...
                                  onClick={(e) => {
                                    navigate(
                                      `/edit-franchise-district/${row.DistrictID}`
                                    );
                                  }}
                                  data-target={`#`}
                                >
